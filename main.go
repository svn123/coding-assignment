...
var puzzle1 = [][]byte{{'k', 'w', 'h', 'd', 'e', 't', 'a', 'w', 's', 'u', 'w', 's', 'i', 'b', 'o', 'v', 'z', 'e', 'z', 'b'},
...
var puzzle2 = [][]byte{{'i', 'w', 'j', 'm', 'j', 'w', 'v', 'v', 't', 'x', 'm', 'p', 'x', 'b', 's', 'j', 'k', 'i', 'f', 'r'},
...
var sample_word = "abc"
var puz1_srchterm = "netapp"
var puz2_srchterm = "containers"
...
func find_the_word(puzzle [][]byte, word string) int {
	...
	if horizontal {
		...
		count++
		if count > 1000000 {
			fmt.Println("No word found after 1000000 rotations for the word : ", word)
			return count
		}
